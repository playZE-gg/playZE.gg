...
***Image of the landmines*** <br/>
***Image of the ramp*** <br/>
***Image of the wall***
...
***Image of the landmines*** <br/>
***Image of the cliff*** <br/>
***Image of the section to defend*** <br/>
***Image of the door to trigger***
...
***Image of right path and surf ramp*** <br/>
***Image of left path with jumps*** <br/>
***Image of moving platform***
...
***Image of platform between the two paths***
...
***Image of the paths from the perspective of humans defending***
...
***Image of the bridges*** <br/>
***Image of the first doors and airlock*** <br/>
***Image of the human defense position, showing where zombies TP in airlock***
...
***Image of the single door to the rest of the ship***
...
| Item | Effect | Notes |
|---|---|---|
| Item Name | What it does | Who should hold it / when to use it |
...
*No video available yet. [Contribute one](/contribute/how-to-contribute/).*
...
*If the strategies here are outdated, please [open an issue](https://github.com/playZE-gg/playZE.gg/issues/new?template=outdated-info.md).*
